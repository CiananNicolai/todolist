		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "To-Do List",
									"targetURL": "#todolisttodolist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"todolisttodolist-display": {
								"semanticObject": "todolisttodolist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=todolist.todolist",
									"url": sap.ui.require.toUrl("todolist/todolist")
								}
							}
						}
					}
